...
@Composable
fun FinalScreen(navHostController: NavHostController, pathOfFile: String,pathOfDir:String, mimeType:String,stringResource:Int) {
    BackHandler {
    ...
    Column(modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Button(
            ...
            Text(text = stringResource(stringResource), color = Color.White)
        }
        Spacer(modifier = Modifier.height(10.dp))
        OutlinedButton(
            onClick = {
