...
import com.pzbdownloaders.redpdfpro.conversionsfeature.convertPdfToAnyFormat.pdftotxtfeature.presentation.screen.PdfToTxtScreen
...
import com.pzbdownloaders.redpdfpro.conversionsfeature.otherconversions.txttoepub.presentation.screen.TxtToEpubScreen
...
import com.pzbdownloaders.redpdfpro.conversionsfeature.otherconversions.xlsxtoxlsfeature.presentation.screen.XlsxToXlsScreen
...
fun NavGraphBuilder.toolsGraph(
    ...
    navigation(
        ...
        composable(Screens.DocxToEpub.route) {
            DocxToEpubScreen(activity, viewModel, navHostController)
        }
        composable(Screens.XlsToCsv.route) {
            XlsToCsvScreen(activity, viewModel, navHostController)
        }
        ...
        composable(Screens.XlsxToXls.route) {
            XlsxToXlsScreen(activity, viewModel, navHostController)
        }
        ...
        composable(Screens.PdfToTxt.route) {
            PdfToTxtScreen(activity, viewModel, navHostController)
        }
    }
}