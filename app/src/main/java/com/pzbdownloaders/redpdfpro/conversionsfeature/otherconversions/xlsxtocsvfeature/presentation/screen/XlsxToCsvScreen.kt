package com.pzbdownloaders.redpdfpro.conversionsfeature.otherconversions.xlsxtocsvfeature.presentation.screen
...
fun XlsxToCsvScreen(
    ...
    val result = rememberLauncherForActivityResult(
        ...
        onResult = {
            if (it != null) {
                pathOfXlsFile.value = getFilePathFromContentUriForXlsx(it, activity)!!
