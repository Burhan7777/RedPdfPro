package com.pzbdownloaders.redpdfpro.conversionsfeature.otherconversions.docxtoepubfeature.presentation.screen
    ...
    val pullRefreshState = rememberPullRefreshState(
        ...
        onRefresh = {
            ...
            scope.launch(Dispatchers.Default) {
                ...
                viewModel.mutableStateListOfDocx.clear()
                viewModel.listOfDocxNames.clear()
                getDocs(listOfDocx, activity, viewModel.listOfDocxNames, viewModel.listOfSize)
            ...
            AlertDialogBox(
                ...
                featureExecution = {
                    ...
                    scope.launch(Dispatchers.IO) {
                        ...
                        val result = module.callAttr("make_request", pathOfDocxFile.value, "epub")
