package com.pzbdownloaders.redpdfpro.conversionsfeature.convertPdfToAnyFormat.pdftodocfeature.presentation.screen
            ...
            AlertDialogBox(
                ...
                featureExecution = {
                    ...
                    scope.launch(Dispatchers.IO) {
                        ...
                        val result = module.callAttr("make_request", pathOfPdfFIle.value, "doc")
...
fun checkJobStatus(
    ...
    val path =
        "${Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)}/Pro Scanner/docx/${nameOfFile.value}.doc"
    scope.launch(Dispatchers.IO) {
        delay(3000)
