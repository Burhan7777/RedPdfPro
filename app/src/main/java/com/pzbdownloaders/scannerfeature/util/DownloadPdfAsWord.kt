...
fun convertPdfToImage(context: Context, path: String) {
    ...
    getTextFromPdf(context, listOfFIlePaths)
}

fun getTextFromPdf(context: Context, listOfFilePaths: List<String>) {
    ...
    addTextToTheWordFile(finalText, "")
}

fun addTextToTheWordFile(text: String, name: String) {
    ...
    module.callAttr("create_docx_from_text", text, "demo1")
    println("Successful")
}
